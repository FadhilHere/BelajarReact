  ...
  function Logo() {
    return (
      <div className="flex flex-row items-center">
        <img src={"./Logo.png"} className="w-10 h-10 mr-[8px]" alt="Logo" />
  ...
  function LoginRegister() {
    return (
      <div className="flex space-x-4">
        <button className="px-12 py-2 border border-[#545BE8] text-[#545BE8] rounded-lg hover:bg-[#545BE8] hover:text-white transition-colors duration-300">
          Log in
        </button>
        <button className="px-12 py-2 bg-[#545BE8] text-white rounded-lg hover:bg-[#3e46d7] transition-colors duration-300">
          Register
        </button>
      </div>
    );
